...
public class ClienteDAO implements Metodos {
	...
	//JBC NATIVO, nos permite desarrollar más lentamente una aplicacion
//al tener que formular las sentencias SQL y con más lineas de codigo
//pero la respuesta desde el servidor y hacia el frente es más rápida

//Hinernate - Utiliza frameworks como Hibernate permite una velocidad
//de desarrollo más rpaida al ser menos código, pero una respuesta 
//más lenta en la peticion del servidor