...
public class Update {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ps.setString(1, "ING. AERONAUTICA");
			ps.setString(2,"EXACTAS");
			ps.setString(3, "10 SEMESTRES");
			ps.setInt(4, 180000);
			ps.setInt(5, 23); //AQUI SI TENGO QUE ENVIAR EL ID QUE QUIERO EDITAR
			...
			if (flag == 1) {
				System.out.println("Carrera Editado exitosamente");
			}else {
