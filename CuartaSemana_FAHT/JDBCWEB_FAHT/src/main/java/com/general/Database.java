...
public class Database {
	...
	//Creamos un constructor mixto, porque me va a permitir
	//crear mi ibjto Database "vacio", pero que en realidad
	//tiene acceso a la info guardada aqui para poder recuperarla
	public Database() {
		super();
		this.driver = driver;
		this.url = url;
