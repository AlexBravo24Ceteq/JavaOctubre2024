...
public class Cajero implements IMetodos{
	...
	//Vamos a declarar unos atributros de nuestro cajero
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		if(consultar(numeroCuenta) != null) {
			...
			//Una vez localidaza la cuenta para manipular
			//realizamos ciertas validaciones
			if(monto>9000) {//Valida si el monto excede el maximo permitido por el cajero
				...
				//Actualizamos el sueldo de nuestra cuenta
