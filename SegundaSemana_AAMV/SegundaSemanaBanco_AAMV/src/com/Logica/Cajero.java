...
public class Cajero implements IMetodos {
	// En el paquete com.logica se ecncuentra lka clase encargada de resolver las
	// operaciones
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		// Entonces asignamos posteriormente la cuenta si eziste en el HashMap
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > 9000) {// Validamos si el monto excede el maximo que demilita el cajero
				...
				return ticket;
					...
					// Actualizamos el saldo de nustra cuenta
				cuenta.setSaldo(cuenta.getSaldo() - monto); // Es decir realizamos el retiro
				// Entonces emitimos un nuevo ticket por tener la operacion exitosa
