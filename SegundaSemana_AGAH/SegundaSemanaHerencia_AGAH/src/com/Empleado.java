...
public class Empleado extends Persona {
	...
	//Atributos propios de un empleado porque los otros los estariamos
	...
	public int sumar (int a, int b) {//Se pueden declarar las variables
	 ...
	 * les deben definir las clases hijas (Sobreescribir)
	 */
	@Override
