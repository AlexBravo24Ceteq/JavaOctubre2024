...
public class Cajero implements IMetodos {
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		/*
		 * vamos a buscar la cuenta y necesitamos hacer unas validaciones primero, si se
		 * encuentra o localiza la cuenta, la asignamos para manipularla
		 */
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > 9000) { // Validamos si el monto excede el maximo del cajero
				...
				return ticket;
			} else {// si el retiro puede realizarse acutializamos el saldo de nuestra cuenta
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > cuenta.getSaldoMax()) {
				...
				System.out.println("El monto excederia el máximo permitido en la cuenta");
				return ticket;
			} else {
