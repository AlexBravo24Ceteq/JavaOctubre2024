...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Creando las cuentas directam,ente en el HashMap
		...
		//Probar el metodo retirar exitiso
		System.out.println(angelopolis.retirar(1001, 9000));
		System.out.println(angelopolis.retirar(1001, 1000));
		
		//Quiero retirar dinero de uan cuenta que no existe
		System.out.println(angelopolis.retirar(1006, 9000));
