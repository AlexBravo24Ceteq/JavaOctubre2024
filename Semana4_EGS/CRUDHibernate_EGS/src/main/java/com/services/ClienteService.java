...
public class ClienteService {
	...
	// http://localhost:8095/CRUDHibernate_EGS/CRUDHibernate_EGS/clientes/mostrar
	...
	@Produces({ MediaType.APPLICATION_JSON })
	// http://localhost:8095/CRUDHibernate_EGS/CRUDHibernate_EGS/clientes/guardar
	...
	@DELETE
	@Produces({ MediaType.APPLICATION_JSON })
	// http://localhost:8095/CRUDHibernate_EGS/CRUDHibernate_EGS/clientes/eliminar/id
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	// http://localhost:8095/CRUDHibernate_EGS/CRUDHibernate_EGS/clientes/editar
	...
	@Consumes({MediaType.APPLICATION_JSON}) 
	@Produces({MediaType.APPLICATION_JSON}) 
	// http://localhost:8095/CRUDHibernate_EGS/CRUDHibernate_EGS/clientes/buscar-por-id/id
