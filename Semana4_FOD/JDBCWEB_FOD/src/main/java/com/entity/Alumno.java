...
public class Alumno {
	...
	//en el paquete com.entuty vamos a crear o modelar nuestros objetos 
	//que representan entidades en nuestras bases de datos para poder manipularlos desde aqui en java 
